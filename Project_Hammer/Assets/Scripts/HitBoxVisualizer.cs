...
public class HitBoxVisualizer : MonoBehaviour
{
    ...
    private void SpawnHitBoxes(Collider hitBox)
    {
        if (hitBox is BoxCollider)
        {
            ...
            GameObject visualizer = Instantiate(RectangleSprite, box.center + box.gameObject.transform.position, Quaternion.Euler(-90, 0, 0), worldCanvas.transform);
        ...
        else if (hitBox is SphereCollider)
        {
            ...
            GameObject visualizer = Instantiate(CircleSprite, sphere.center + sphere.gameObject.transform.position, Quaternion.Euler(-90, 0, 0), worldCanvas.transform);
